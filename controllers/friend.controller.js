...
friendController.createRequest = catchAsync (async(req, res, next) => {
    ...
    if (!friend) {
        ...
        // status === accepted -> error: already friend
            case "accepted":
                throw new AppError( 400, "Users are already friends", "Add Friend Error")
...
friendController.getSentFriendRequestList = catchAsync (async(req, res, next) => {
    ...
    return sendResponse(
        ...
        {users: usersWithFriendship, totalPages, count},
        null,
        "Get Sent Request List Successfully"
    )
});
...
friendController.reactFriendRequest = catchAsync (async(req, res, next) => {
    ...
    if (!friend) throw new AppError(400, "Friend Request not found", "React Friend Request Error")
...
friendController.removeFriend = catchAsync (async(req, res, next) => {
    ...
    if (!friend) throw new AppError(400, "Friend not found", "Remove Friend Error");
